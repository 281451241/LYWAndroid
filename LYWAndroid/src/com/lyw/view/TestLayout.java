...
public class TestLayout extends ViewGroup {
    ...
    private int getPaddingLeftWithForeground() {
        return mForegroundInPadding ? Math.max(0, mForegroundPaddingLeft) :
            0 + mForegroundPaddingLeft;
    }

    private int getPaddingRightWithForeground() {
        return mForegroundInPadding ? Math.max(0, mForegroundPaddingRight) :
            0 + mForegroundPaddingRight;
    }

    private int getPaddingTopWithForeground() {
        return mForegroundInPadding ? Math.max(0, mForegroundPaddingTop) :
            0 + mForegroundPaddingTop;
    }

    private int getPaddingBottomWithForeground() {
        return mForegroundInPadding ? Math.max(0, mForegroundPaddingBottom) :
            0 + mForegroundPaddingBottom;
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(TestLayout.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(TestLayout.class.getName());
    }
